...
def get_listings(soup):
    ...
    vehicle_cards =  vehicle_cards = soup.select('div.cBox-body.cBox-body--resultitem, div.cBox-body.cBox-body--eyeCatcher')
    logging.info(f"Found {len(vehicle_cards)} vehicle cards on the current page")
    ...
    logging.info(f"Found {len(listings)} listings on the current page")
    return listings
    ...
    try:
        ...
        while current_url and count < max_count:  # Modified this line to include count < max_count
            ...
            if driver.page_source:
                                    # Assume CAPTCHA pops up at this point
                ...
                logging.info(f"Listings: {listing_urls}")
                ...
                try:
                    next_button = driver.find_element(By.CSS_SELECTOR, "your-next-button-css-selector")
